...
A Typescript implementation task to build a complete RAG system for microwave manual assistance using PostgreSQL with pgvector extension and DIAL API

File copied from https://github.com/khshanovskyi/ai-dial-rag-advanced/blob/main/README.md
