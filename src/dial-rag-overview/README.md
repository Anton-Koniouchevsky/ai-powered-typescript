...
A Typescript implementation task to build a complete RAG system for microwave manual assistance using LangChain, FAISS, and Azure OpenAI

File copied from https://github.com/khshanovskyi/ai-dial-rag-overview/blob/main/README.md
